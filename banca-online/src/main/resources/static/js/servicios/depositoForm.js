function initDepositoForm() {
    console.log('🚀 Inicializando formulario de depósito...');
    ...
    setTimeout(() => {
        ...
        if (!cuenta) {
            ...
            const mensajeError = document.getElementById('mensajeErrorDepositoForm');
            if (mensajeError) {
        ...
        const cuentaNumeroSpan = document.getElementById('cuentaNumeroDeposito');
        const cuentaSaldoSpan = document.getElementById('cuentaSaldoDeposito');
        ...
        const form = document.getElementById('formDepositoForm');
        const btnCerrar = document.getElementById('btnCerrarDepositoForm');
        const btnCancelar = document.getElementById('btnCancelarDepositoForm');
        const mensajeExito = document.getElementById('mensajeExitoDepositoForm');
        const mensajeError = document.getElementById('mensajeErrorDepositoForm');
        ...
        function mostrarExito(mensaje, nuevoSaldo) {
            ...
            const saldoSpan = document.getElementById('cuentaSaldoDeposito');
        ...
        function mostrarAlertaTimeout(btnGuardar) {
            if (!isRequestCompleted) {
                ...
                if (btnGuardar) {
                    ...
                    btnGuardar.textContent = 'Confirmar Depósito';
                }
            }
        }
        ...
        function cerrarModal() {
            ...
            const modal = document.getElementById('modal-depositoForm');
        ...
        if (form) {
            form.onsubmit = async (e) => {
                ...
                console.log('📤 Depositando en cuenta:', cuenta.id);
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        mostrarExito(`✅ Depósito exitoso! Nuevo saldo: ${data.saldo.toFixed(2)} €`, data.saldo);
                        form.reset();
                        setTimeout(() => {
                            cerrarModal();
                        }, 2000);
                        ...
                        mostrarError(error.message || 'Error al realizar el depósito');
                        if (btnGuardar) {
                            btnGuardar.disabled = false;
                            btnGuardar.textContent = 'Confirmar Depósito';
                        }
        ...
        console.log('✅ depositoForm inicializado');
    }, 100);
}

window.initDepositoForm = initDepositoForm;